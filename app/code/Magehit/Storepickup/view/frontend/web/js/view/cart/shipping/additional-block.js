define([
...
], function ($, ko, Component, quote, storage, url, getTotalsAction) {
	'use strict';
	...
	return Component.extend({
		defaults: {
			template: 'Magehit_Storepickup/cart/shipping/additional-block'
		},
		initialize: function () {
			this._super();
			this.dob = ko.observable(new Date());
			if (this.selectedMethod().selectedStoreId) {
				$('#storepickup_store').change();
			}
		},
		...
		getAjaxinfo: function (ele, event) {
			var self = this;
